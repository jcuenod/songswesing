class UsagesController < ApplicationController
	...
	def data
		@usages = policy_scope Usage.limit(params[:limit]).select("MAX(services.date) as date", :song_name, :song_id, "count(song_id) as count_song_id").joins(:service, :song).group(:song_name, :song_id).order("count_song_id DESC")
